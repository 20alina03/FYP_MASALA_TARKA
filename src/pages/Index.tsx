...
import { ChefHat, Sparkles, BookOpen, AlertCircle, Key, Clock, Users, Zap } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* API Key Section - Simplified */}
      {showApiKeyInput && (
        <section className="py-12 bg-muted/20">
          <div className="container mx-auto px-4">
            <Card className="max-w-2xl mx-auto p-6 bg-card border shadow-sm">
      ...
      {/* Recipe Generator Section - Modernized */}
      ...
      {/* Generated Recipes Section - Clean Design */}
      {recipes.length > 0 && (
